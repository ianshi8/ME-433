...
def webpage():
    ...
    <h1>Ian's Pico W HTTP Server</h1>
    <br>
    ...
    <form accept-charset="utf-8" method="POST">
    <h1>Use stopwatch with the following button:</h1><br>
    <button class="button" name="STOPWATCH" value="WATCH" type="submit">STOPWATCH</button></a></p></form>
    <p class="dotted">Time Elapsed:
    <span style="color: deeppink;">{elapsed_time} {time_unit}</span></p><br>
    </body>
    <script>
    </html>
    """
